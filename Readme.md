...
# Parsing + Configuration Script – Carbonlesss - Rev. A

This **Parsing + Configuration** script is designed for the **Carbonlesss** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Carbonlesss Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Carbonlesss** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
